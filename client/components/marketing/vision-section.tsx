            ...
            <div className="relative min-h-[300px] flex items-center justify-center select-none">
              ...
              <div className="absolute inset-0">
                <svg className="w-full h-full" viewBox="0 0 600 300" fill="none">
                  <defs>
                    <linearGradient id="vis-grad-l-v-alt" x1="0%" y1="0%" x2="0%" y2="100%">
                  ...
                  <path d="M180,60 L300,140" stroke="url(#vis-grad-l-v-alt)" strokeWidth="1.5" strokeDasharray="3,3" />
                  <path d="M420,60 L300,140" stroke="url(#vis-grad-l-v-alt)" strokeWidth="1.5" strokeDasharray="3,3" />
                  <path d="M300,170 L200,240" stroke="url(#vis-grad-l-v-alt)" strokeWidth="1.5" strokeDasharray="3,3" />
                  <path d="M300,170 L400,240" stroke="url(#vis-grad-l-v-alt)" strokeWidth="1.5" strokeDasharray="3,3" />
                </svg>
              </div>
