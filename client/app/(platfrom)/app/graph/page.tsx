...
import { BarChartIcon as BarChart2, ArrowLeft01Icon as ArrowLeft } from "@hugeicons/core-free-icons";
    ...
    <div className="h-full w-full max-w-4xl mx-auto flex flex-col items-center justify-center text-center px-6">
      ...
      <div className="space-y-4 max-w-md mx-auto">
        ...
        <p className="text-muted-foreground text-xs md:text-sm leading-relaxed">
          We&apos;re building a conceptual network view that maps the connections between your saves automatically.
        </p>
      </div>
