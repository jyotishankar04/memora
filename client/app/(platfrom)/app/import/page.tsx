...
import { Upload01Icon as Upload, ArrowLeft01Icon as ArrowLeft } from "@hugeicons/core-free-icons";
    ...
    <div className="h-full w-full max-w-4xl mx-auto flex flex-col items-center justify-center text-center px-6">
      ...
      <div className="relative w-16 h-16 flex items-center justify-center mb-6">
        ...
        <div className="w-14 h-14 rounded-2xl border border-primary/30 flex items-center justify-center bg-card shadow-md">
          <HugeiconsIcon icon={Upload} strokeWidth={2.25} className="h-7 w-7 text-primary" />
        </div>
      </div>
      ...
      <div className="space-y-4 max-w-md mx-auto">
        ...
        <p className="text-muted-foreground text-xs md:text-sm leading-relaxed">
          We&apos;re building real bulk import from browser bookmarks, Pocket, Notion, and Raindrop.
        </p>
      </div>
